package com.wangchangzheng.zhihu.activity;
...
import com.wangchangzheng.zhihu.db.CacheDbHelper;
import com.wangchangzheng.zhihu.fragment.MainFragment;
import com.wangchangzheng.zhihu.fragment.MenuFragment;
import com.wangchangzheng.zhihu.fragment.NewsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_mode) {
            isLight = !isLight;
            // TODO: 16-5-23 现在只有这个activity有夜间模式，打开日报详情还不是啊
    ...
    public void onBackPressed() {
        if (mDrawerLayout.isDrawerOpen(Gravity.LEFT)) {
            ...
            if (secondTime - firstTime > 2000) {
                Snackbar sb = Snackbar.make(fl_content, "阿正温馨提示：再按一次退出", Snackbar.LENGTH_SHORT);
